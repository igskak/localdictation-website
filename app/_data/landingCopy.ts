...
const de: LandingCopy = {
  ...
  comparison: {
    ...
    note: "Wenn du Whisper selbst einrichten möchtest, sind Open-Source-Tools eine gute Wahl. Witness ist für alle, die stattdessen direkt arbeiten wollen — fertig eingerichtet, mit Sprachprofilen, Verifikation und erreichbarem Support.",
  ...
  faq: {
    ...
    items: [
      ...
      { q: "Welche Sprachen werden unterstützt?", a: "Deutsch, Englisch, Russisch und Ukrainisch — einzeln oder in gemischten Profilen." },
...
const ru: LandingCopy = {
  ...
  comparison: {
    ...
    note: "Если тебе нравится настраивать Whisper самому, open-source — хороший выбор. Witness для тех, кто вместо этого хочет сразу работать: всё настроено, есть языковые профили, проверка и живая поддержка.",
...
const uk: LandingCopy = {
  ...
  comparison: {
    ...
    note: "Якщо тобі подобається налаштовувати Whisper самому, open-source — гарний вибір. Witness для тих, хто натомість хоче одразу працювати: усе налаштовано, є мовні профілі, перевірка та жива підтримка.",

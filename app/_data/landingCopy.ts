...
const de: LandingCopy = {
  ...
  hero: {
    ...
    audience: "Für alle, die mehr als eine Sprache benutzen — und sie in einem Satz mischen.",
    download: "Für Mac laden",
    fine: ["13 Tage voller Funktionsumfang", "3 Tage ohne E-Mail, dann Schlüssel per Mail", "Apple Silicon", "macOS 14.4+", "keine Kreditkarte"],
  },
  ...
  verification: {
    ...
    body: "Witness markiert Zahlen, Datumsangaben, Eigennamen, Verneinungen und Wörterbuchbegriffe vor der Einfügung. Spiele den Originalton ab, vergleiche das Roh-Transkript und bestätige erst dann.",
    points: ["Originalton", "Roh-Transkript", "Deine Bestätigung"],
  },
  privacy: {
    kicker: "Privatsphäre",
    title: "Offline heißt offline — und du kannst es nachprüfen",
    lede: "WLAN aus, weiterdiktieren. Die Sprachverarbeitung bleibt verfügbar.",
  ...
  comparison: {
    ...
    caption: "Witness im Vergleich mit vier Diktier-Apps",
    featureHead: "Merkmal",
    rows: [
      ...
      ["Sprachwahl", "angekreuzt, 4 gemessen", "100+ Sprachen", "Auto-Erkennung", "Sprache je Modus", "modellabhängig"],
      ["Kostenloser Einstieg", "13 Tage Vollversion", "Basic mit Wochenlimit", "14 Tage Vollversion", "dauerhafter Free-Tarif", "14 Tage Erstattungsfrist"],
      ["Bezahlpreis", "€99 einmalig / €49 Jahr", "$15 Monat / $144 Jahr", "€10,99 Monat, jährlich", "$84.99 Jahr / $249.99 Lifetime", "$25 / $39 / $49 einmalig"],
      ["Fertiger Mac-Download", "ja", "ja", "ja", "ja", "ja"],
    ],
  ...
  pricing: {
    ...
    annual: { name: "Jahreslizenz", vat: "inkl. MwSt. / Jahr", body: "Ein Jahr nutzen, danach kündbar.", bullets: ["2 Macs", "Alle Updates im Zeitraum"] },
    download: "Für Mac laden",
  ...
  faq: {
    ...
    items: [
      ...
      { q: "Was passiert nach den 13 Testtagen?", a: "Neue Diktate werden pausiert und die App zeigt die beiden Lizenzoptionen. Einstellungen und Lizenzaktivierung bleiben erreichbar." },
  ...
  final: {
    ...
    body: "Lade Witness, drück den Hotkey, sprich. Die ersten drei Tage ab deiner ersten erfolgreichen Diktierung fragen nach nichts. Danach brauchst du einen E-Mail-Schlüssel, der zehn weitere Tage freischaltet — ohne Produktkonto und ohne Kreditkarte. Der Schlüssel kommt sofort in der App an; die Kopie per Mail ist nur für eine Neuinstallation. Beim Entfernen bleibt kein Audio- oder Transkriptarchiv zurück.",
    download: "Für Mac laden",
...
const en: LandingCopy = {
  ...
  hero: {
    ...
    audience: "For people who use more than one language — and mix them in the same sentence.",
    download: "Download for Mac",
    fine: ["13-day full trial", "3 days without an email, then a key by mail", "Apple silicon", "macOS 14.4+", "no credit card"],
  },
  ...
  verification: {
    ...
    body: "Witness highlights numbers, dates, names, negations, and vocabulary terms before insertion. Play the original audio, compare the raw transcript, and confirm only then.",
    points: ["Original audio", "Raw transcript", "Your confirmation"],
  },
  privacy: {
    kicker: "Privacy",
    title: "Offline means offline — and you can verify it",
    lede: "Turn Wi‑Fi off and keep dictating. Speech processing stays available.",
  ...
  comparison: {
    ...
    caption: "Witness compared with four dictation apps",
    featureHead: "Feature",
    rows: [
      ...
      ["Language choice", "ticked by you, 4 measured", "100+ languages", "auto-detection", "language per mode", "model-dependent"],
      ["Free entry", "13-day full trial", "Basic with weekly limit", "14-day full trial", "ongoing free tier", "14-day refund window"],
      ["Paid price", "€99 once / €49 year", "$15 month / $144 year", "€10.99 month, billed annually", "$84.99 year / $249.99 lifetime", "$25 / $39 / $49 once"],
      ["Ready Mac download", "yes", "yes", "yes", "yes", "yes"],
    ],
  ...
  pricing: {
    ...
    annual: { name: "Annual licence", vat: "incl. VAT / year", body: "Use it for one year, then cancel.", bullets: ["2 Macs", "All updates during your term"] },
    download: "Download for Mac",
  ...
  faq: {
    ...
    items: [
      ...
      { q: "What happens after the 13-day trial?", a: "New dictations pause and the app shows both licence options. Settings and licence activation stay available." },
  ...
  final: {
    ...
    body: "Download Witness, press the hotkey, and speak. The first three days after your first successful dictation ask for nothing. After them an email key adds ten more days — with no product account or credit card. The key arrives in the app straight away; the copy in your mail is only for a reinstall. Removing the app leaves no audio or transcript archive behind.",
    download: "Download for Mac",
    ready: "Apple silicon · macOS 14.4+",
...
const ru: LandingCopy = {
  ...
  hero: {
    ...
    audience: "Для тех, кто использует больше одного языка — и мешает их в одном предложении.",
    download: "Скачать для Mac",
    fine: ["13 дней полной версии", "3 дня без почты, потом ключ на почту", "Apple Silicon", "macOS 14.4+", "без карты"],
  },
  ...
  verification: {
    ...
    body: "Witness подсвечивает числа, даты, имена, отрицания и слова из твоего словаря до вставки. Прослушай оригинал, сравни с исходным транскриптом — и только потом подтверди.",
    points: ["Оригинал записи", "Исходный транскрипт", "Твоё подтверждение"],
  },
  privacy: {
    kicker: "Приватность",
    title: "Офлайн значит офлайн — и это можно проверить",
    lede: "Выключи Wi-Fi и продолжай диктовать. Распознавание останется доступным.",
  ...
  comparison: {
    ...
    caption: "Witness в сравнении с четырьмя диктовщиками",
    ...
    rows: [
      ...
      ["Выбор языков", "отмечаешь сам, 4 проверены", "100+ языков", "автоопределение", "язык на каждый режим", "зависит от модели"],
      ["Бесплатный вход", "13 дней полной версии", "Basic с недельным лимитом", "14 дней полной версии", "бессрочный бесплатный тариф", "14 дней на возврат"],
      ...
      ["Готовая сборка для Mac", "да", "да", "да", "да", "да"],
    ],
  ...
  pricing: {
    ...
    annual: { name: "Лицензия на год", vat: "включая НДС / год", body: "Год пользуешься, дальше можно не продлевать.", bullets: ["2 Mac", "Все обновления в течение срока"] },
    download: "Скачать для Mac",
  ...
  faq: {
    ...
    items: [
      ...
      { q: "Что будет после 13 дней теста?", a: "Новые диктовки ставятся на паузу, и приложение показывает два варианта лицензии. Настройки и активация остаются доступны." },
  ...
  final: {
    ...
    body: "Скачай Witness, нажми хоткей, говори. Первые три дня после первой успешной диктовки не спрашивают ничего. Дальше ключ по почте добавляет ещё десять дней — без аккаунта в продукте и без карты. Ключ приходит сразу в приложение; копия на почте нужна только при переустановке. После удаления не остаётся ни архива аудио, ни транскриптов.",
    download: "Скачать для Mac",
    ready: "Apple Silicon · macOS 14.4+",
...
const uk: LandingCopy = {
  ...
  hero: {
    ...
    audience: "Для тих, хто використовує більше ніж одну мову — і змішує їх в одному реченні.",
    download: "Завантажити для Mac",
    fine: ["13 днів повної версії", "3 дні без пошти, потім ключ на пошту", "Apple Silicon", "macOS 14.4+", "без картки"],
  },
  ...
  verification: {
    ...
    body: "Witness підсвічує числа, дати, імена, заперечення та слова з твого словника до вставлення. Прослухай оригінал, порівняй із вихідним транскриптом — і лише тоді підтвердь.",
    points: ["Оригінал запису", "Вихідний транскрипт", "Твоє підтвердження"],
  },
  privacy: {
    kicker: "Приватність",
    title: "Офлайн означає офлайн — і це можна перевірити",
    lede: "Вимкни Wi-Fi і диктуй далі. Розпізнавання лишиться доступним.",
  ...
  comparison: {
    ...
    caption: "Witness у порівнянні з чотирма диктувальниками",
    featureHead: "Параметр",
    rows: [
      ...
      ["Вибір мов", "позначаєш сам, 4 виміряні", "100+ мов", "автовизначення", "мова на кожен режим", "залежить від моделі"],
      ["Безкоштовний вхід", "13 днів повної версії", "Basic із тижневим лімітом", "14 днів повної версії", "безстроковий безкоштовний тариф", "14 днів на повернення"],
      ...
      ["Готова збірка для Mac", "так", "так", "так", "так", "так"],
    ],
  ...
  pricing: {
    ...
    annual: { name: "Ліцензія на рік", vat: "включно з ПДВ / рік", body: "Рік користуєшся, далі можна не продовжувати.", bullets: ["2 Mac", "Усі оновлення протягом строку"] },
    download: "Завантажити для Mac",
  ...
  faq: {
    ...
    items: [
      ...
      { q: "Що буде після 13 днів тесту?", a: "Нові диктування ставляться на паузу, і застосунок показує два варіанти ліцензії. Налаштування та активація лишаються доступними." },
  ...
  final: {
    ...
    body: "Завантаж Witness, натисни гарячу клавішу, говори. Перші три дні після першого успішного диктування не питають нічого. Далі ключ поштою додає ще десять днів — без облікового запису в продукті й без картки. Ключ приходить одразу в застосунок; копія на пошті потрібна лише для перевстановлення. Після видалення не лишається ні архіву аудіо, ні транскриптів.",
    download: "Завантажити для Mac",
    ready: "Apple Silicon · macOS 14.4+",
